...
export class FileSystemHelper {
    ...
    public async writeFile(filePath: string, data: string, options = {}) {
        return new Promise((resolve, reject) => {
    ...
    public async rmdir(dirPath: string) {
        return new Promise((resolve) => {
    ...
    public async rm(filePath: string) {
        return new Promise((resolve, reject) => {
    ...
    public async readDir(
        dirPath: string = '.',
        options: { acceptExtensions?: string[]; recursiveLevels?: number; onlyFiles?: boolean; onlyDirs?: boolean } = {}
    ): Promise<fs.Dirent[]> {
        return new Promise((resolve, reject) => {
    ...
    public readDirSync(
        ...
        const files = fs.readdirSync(this.resolvePath(dirPath), { withFileTypes: true })
        const { acceptExtensions, recursiveLevels, onlyFiles, onlyDirs } = options
        let acceptedFiles = files
        if (acceptExtensions) {
            acceptedFiles = acceptedFiles.filter(
